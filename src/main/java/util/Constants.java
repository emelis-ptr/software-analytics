...
public class Constants {
    ...
    public static final String PATH_RESULTS_M1 = PATH_RESULTS + project(PROJ_NAME_M1) + File.separator;
    public static final String PATH_RESULTS_M2 = PATH_RESULTS + project(PROJ_NAME_M2) + File.separator;
